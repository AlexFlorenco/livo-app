...
export interface ApiGradeGrade extends Schema.CollectionType {
  ...
  attributes: {
    grade: Attribute.Enumeration<['primeiro', 'segundo', 'terceiro']>;
    book: Attribute.Relation<'api::grade.grade', 'manyToOne', 'api::book.book'>;
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    type: Attribute.Enumeration<['professor', 'aluno']>;
    grades: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::grade.grade'
